...
export class AdminEditAdComponent implements OnInit {
  ...
  years:any
  constructor(private _cookieService:CookieService,private route: ActivatedRoute,private loginService: LoginService,private router : Router,private formBuilder: FormBuilder,private ngxService: NgxUiLoaderService,private toastr: ToastrService,private adminService : AdminService) {}
  AdForm : FormGroup
  submitted = false
  intCol = 'beige';
  extCol = 'beige';
  ...
  ngOnInit() {
    ...
    this.adID = this.adminService.getAdminAd().AdID
